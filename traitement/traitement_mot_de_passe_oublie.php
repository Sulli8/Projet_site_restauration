...
try {
  $bdd = new PDO('mysql:host=localhost;dbname=projet_site_lycee;charset=utf8','root','root');
}
catch(Exception $e)
{
...
if(isset($connexion)){
  if(isset($mail)){
    ...
    $mail->Body    = "<a href='http://localhost/Projet_site_Restauration/vu/confirmation_mot_de_passe_oublie.php'>Réinitialiser mot de passe</a>";
